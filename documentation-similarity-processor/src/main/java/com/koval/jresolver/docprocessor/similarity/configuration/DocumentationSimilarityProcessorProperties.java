package com.koval.jresolver.docprocessor.similarity.configuration;
...
public class DocumentationSimilarityProcessorProperties {

  private static final Logger LOGGER = LoggerFactory.getLogger(DocumentationSimilarityProcessorProperties.class);

  private static final String SIMILARITY_PROCESSOR_PROPERTIES_FILE = "documentation-similarity-processor.properties";
  ...
  public DocumentationSimilarityProcessorProperties() {
    loadProperties();
  }
  ...
  private void loadProperties() {
    ...
    try (InputStream input = getClass().getClassLoader().getResourceAsStream(SIMILARITY_PROCESSOR_PROPERTIES_FILE)) {
      ...
      throw new ConfigurationException("Could not load the documentation similarity processor properties.", e);
    }
    LOGGER.debug("Documentation similarity processor configuration was loaded successfully.");
  }
  ...
  public String toString() {
    return "DocumentationSimilarityProcessorProperties{"
