...
public class VectorModelCreator {
  ...
  private DocumentationSimilarityProcessorProperties similarityProcessorProperties;

  public VectorModelCreator(DocumentationSimilarityProcessorProperties similarityProcessorProperties) {
  ...
  public VectorModelCreator(TokenPreProcess tokenPreprocessor, List<String> stopWords, DocumentationSimilarityProcessorProperties similarityProcessorProperties) {
