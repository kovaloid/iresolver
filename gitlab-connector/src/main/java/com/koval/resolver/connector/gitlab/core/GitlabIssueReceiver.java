...
public class GitlabIssueReceiver implements IssueReceiver {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(GitlabIssueReceiver.class);
  ...
  public GitlabIssueReceiver(final IssueClient client, final GitlabConnectorConfiguration properties, final boolean isResolvedMode) {
    this.client = client;
